...
def main() -> None:
    print(f"--- [SENDER] Khởi tạo quy trình gửi dữ liệu AES-CBC ---")
    ...
    # 4. Hiển thị thông tin và ghi Log
    lines = [
        "==========================================",
    ...
    # Ghi log thực tế để CI kiểm tra (Yêu cầu bắt buộc của Lab)
    if LOG_FILE:
